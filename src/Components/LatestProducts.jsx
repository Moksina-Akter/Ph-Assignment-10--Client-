    ...
    <section className="px-5 lg:px-20 py-16 bg-gradient-to-b from-purple-50 to-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {products?.map((product) => (
          <div
            key={product._id}
            className="bg-white rounded-lg shadow-lg overflow-hidden hover:scale-105 transform transition flex flex-col justify-between h-full"
          >
            <img
              src={product.image}
              alt={product.name}
...
// // import { fetchLatestProducts } from "../api/latestProducts";

// const LatestProducts = () => {
//   const [products, setProducts] = useState([]);

//   // useEffect(() => {
//   //   fetchLatestProducts(setProducts);
//   // }, []);
